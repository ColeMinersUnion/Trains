...
def getGreen() -> Graph:
    ...
    Greenline.graph.append(Node(index=61, line="Green", section="J", block_length=50, block_grade=0, speed_limit=30, infrastructure="Switch", elevation=0, cumulative_elevation=0.5, connections=[62]))
