...
class CommandCenter(QWidget):
    ...
    def initUI(self):
        ...
        for label in [self.speed_label, self.authority_label, self.brake_status_label, self.suggested_speed_label, self.Kp_Label, self.Ki_Label,  self.current_speed_label, self.power_output_label, self.door_status_label, self.lights_status_label, self.temperature_label, self.hl_status_label]:
    ...
    def update_values(self):
        commanded_speed, authority, brake_status, suggested_speed, current_speed, power_output, door_status, lights_status, internal_temperature, headlights_status = self.backend.get_testbench_status()
        Kp, Ki =  self.backend.get_Kp_Ki()
