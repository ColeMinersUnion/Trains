...
class Backend:
    ...
    def set_testbench_inputs(self, commanded_speed, authority, brake_status, suggested_speed, current_speed, power_output, door_status, lights_status, internal_temperature, headlights_status):
    ...
    def update_testbench_status(self, commanded_speed, authority, brake_status, suggested_speed,  current_speed, power_output, door_status, lights_status, internal_temperature, headlights_status):
    ...
    def get_testbench_status(self):
        ...
        return self.commanded_speed, self.authority, self.brake_status, self.suggested_speed,  self.current_speed, self.power_output, self.door_status, self.lights_status, self.internal_temperature,  self.headlights_status
